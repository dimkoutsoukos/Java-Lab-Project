...
public class AdminControlPanel extends JFrame {
	...
	public AdminControlPanel() {
		...
		deletePubParticipantBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					cs.setInt(1, Integer.parseInt(memberIdTf3.getText()));
					cs.setInt(2, Integer.parseInt(pubIdTf2.getText()));
		...
		deleteProjectMemberBtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					cs.setInt(1, Integer.parseInt(memberIdTf4.getText()));
					cs.setInt(2, Integer.parseInt(projectIdTf3.getText()));
		...
		lblNewLabel_3.setBounds(76, 737, 64, 25);
		...
		lblNewLabel_2.setBounds(10, 737, 64, 25);
		...
		JLabel lblNewLabel_3_1 = new JLabel("Nikolaou, Koutsoukos");
		lblNewLabel_3_1.setForeground(new Color(47, 79, 79));
		lblNewLabel_3_1.setFont(new Font("Segoe Print", Font.BOLD, 12));
		lblNewLabel_3_1.setBounds(10, 756, 191, 25);
